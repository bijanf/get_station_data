...
if __name__ == '__main__':
    ...
    # assume the text file is named "stations.txt" and is in the same directory as the script
    # read the text file as a pandas dataframe, using fixed width format and specifying the column names
    df = pd.read_fwf("../ids.txt", colspecs=[(0,11), (12,19), (20,27), (28,33), (34,68), (69,74)], names=["ID", "LATITUDE", "LONGITUDE", "ELEVATION", "NAME", "GSN_FLAG"])

    # print the first column of the dataframe, which is the station ID
    print(df["ID"])
